...
date: 2024-06-07
desc: You ran `git status` and got this weird diff at the end that read "No newline at the end of file" and now the reviewer is telling you to fix it, let's take a closer look.
