...
This is more visually interesting, but it still doesn't feel compelling enough to leave a lasting impression. So, I decided to draw vertical lines from the corners of the gird cells almost like plotting a graph.
...
## Conclusion
I learned a lot while working on this particular component, and I definitely want to explore more layouts like this. If you made it this far, thank you reading!